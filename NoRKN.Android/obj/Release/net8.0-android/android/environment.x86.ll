...
@dso_cache = dso_local local_unnamed_addr global [32 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 941096614, ; hash 0x3817fea6, from name: tun2socks.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libtun2socks.so
		ptr null; void* handle (0x0)
	}, ; 7
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1466855340, ; hash 0x576e6fac, from name: libtun2socks.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libtun2socks.so
		ptr null; void* handle (0x0)
	}, ; 10
	...
	%struct.DSOCacheEntry {
		i64 2739597813, ; hash 0xa34af1f5, from name: libtun2socks
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libtun2socks.so
		ptr null; void* handle (0x0)
	}, ; 21
	...
	%struct.DSOCacheEntry {
		i64 3440517862, ; hash 0xcd1222e6, from name: tun2socks
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libtun2socks.so
		ptr null; void* handle (0x0)
	}, ; 26
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [174 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
...
@.env.3 = private unnamed_addr constant [37 x i8] c"bc54e5b5-837c-4b2e-8e3f-b840e4a33182\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [14 x i8] c"com.norkn.app\00", align 1

;DSOCacheEntry
@.DSOCacheEntry.0_name = private unnamed_addr constant [16 x i8] c"libtun2socks.so\00", align 1
