...
@dso_cache = dso_local local_unnamed_addr global [32 x %struct.DSOCacheEntry] [
	%struct.DSOCacheEntry {
		i64 113896978169852789, ; hash 0x194a4b2bccdf375, from name: tun2socks
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2969687028265077688, ; hash 0x2936729e3dd34bb8, from name: tun2socks.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libtun2socks.so
		ptr null; void* handle (0x0)
	}, ; 2
	...
	%struct.DSOCacheEntry {
		i64 9283123198244477704, ; hash 0x80d4475d5d8cdb08, from name: libtun2socks
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libtun2socks.so
		ptr null; void* handle (0x0)
	}, ; 18
	...
	%struct.DSOCacheEntry {
		i64 18380844669773978174, ; hash 0xff15e0d75d829a3e, from name: libtun2socks.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libtun2socks.so
		ptr null; void* handle (0x0)
	} ; 31
...
@.env.3 = private unnamed_addr constant [37 x i8] c"bc54e5b5-837c-4b2e-8e3f-b840e4a33182\00", align 16
...
;DSOCacheEntry
@.DSOCacheEntry.0_name = private unnamed_addr constant [16 x i8] c"libtun2socks.so\00", align 16
